...
<div class="custom-card-long" style="opacity: 0.95;">
    ...
    <p style="color: #94A3B8; font-size: 1.05rem; line-height: 1.6; margin: 0;">
        منصة ذكاء اصطناعي تنشئ حملة تسويقية متكاملة خلال دقائق، بدءًا من تحليل المنتج والجمهور المستهدف، وصولًا إلى إنتاج النصوص الإعلانية، والتصاميم، والتعليق الصوتي، وحقيبة إعلانية جاهزة للنشر.
    </p>
</div>
